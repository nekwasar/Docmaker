    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Animated.View entering={FadeInDown.delay(100).duration(400)}>
        <View style={styles.iconContainer}>
          <View style={styles.iconCircle}>
            <Ionicons name="create" size={48} color={Colors.teal} />
          </View>
        </View>
        <Text style={styles.title}>Edit PDF</Text>
        <Text style={styles.subtitle}>Add text, images, shapes, and annotations to your PDF</Text>
      </Animated.View>
      ...
      <Animated.View entering={FadeInDown.delay(300).duration(400)}>
        <AnimatedPressable onPress={() => {}} haptic="medium" style={styles.actionBtn} disabled>
          <Text style={styles.actionBtnText}>Edit PDF</Text>
        </AnimatedPressable>
      </Animated.View>
...
const styles = StyleSheet.create({
  ...
  iconCircle: { width: 100, height: 100, borderRadius: Radius.full, backgroundColor: Colors.teal + '10', justifyContent: 'center', alignItems: 'center' },
  ...
  actionBtn: { backgroundColor: Colors.teal, borderRadius: Radius.full, paddingVertical: Spacing.lg, alignItems: 'center', ...Shadow.md },
