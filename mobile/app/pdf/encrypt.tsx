          ...
          <Animated.View entering={FadeInDown.delay(100).duration(300)}>
            <View style={styles.card}>
              <View style={styles.fileRow}>
                ...
                <View style={{ flex: 1 }}><Text style={styles.fileName}>document.pdf</Text><Text style={styles.fileMeta}>2.4 MB</Text></View>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.passwordInput}>
                <TextInput style={styles.input} placeholder="Enter password" placeholderTextColor={Colors.textSecondary} value={password} onChangeText={setPassword} secureTextEntry={!showPassword} />
...
const styles = StyleSheet.create({
  ...
  passwordInput: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.canvas, borderRadius: Radius.lg, borderWidth: 1, borderColor: Colors.border },
