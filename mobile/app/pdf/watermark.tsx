        ...
        {!hasFile ? (
          ...
          <Animated.View entering={FadeInDown.delay(100).duration(300)}>
            ...
            <View style={styles.card}>
              ...
              <TextInput style={styles.input} placeholder="Enter watermark text" placeholderTextColor={Colors.textSecondary} value={watermarkText} onChangeText={setWatermarkText} />
            </View>
            <View style={styles.card}>
              <Text style={styles.label}>Preview</Text>
              <View style={styles.previewBox}><Text style={styles.previewText}>{watermarkText}</Text></View>
            </View>
...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: Colors.canvas, borderRadius: Radius.lg, borderWidth: 1, borderColor: Colors.border, padding: Spacing.lg, fontSize: 15, fontWeight: '500', color: Colors.textPrimary },
  previewBox: { backgroundColor: Colors.canvas, borderRadius: Radius.lg, padding: Spacing.xxl, alignItems: 'center', borderWidth: 1, borderColor: Colors.border },
  previewText: { fontSize: 24, fontWeight: '700', color: Brand.teal + '60', letterSpacing: 4 },
