...
export default function AdminUsage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-[22px] font-bold tracking-tight text-[#0F172A]">Usage & Spend</h1>
      ...
      <div className="flex gap-2">
        ...
        />
        <button onClick={() => load(1, model)} className="rounded-[8px] bg-[#0F172A] px-4 py-2 text-[13px] font-semibold text-white hover:bg-black">
          Filter
        </button>
      </div>
