  ...
  return (
    <ToolPageLayout title="Word to PDF" color="blue">
      <div className="space-y-8">
        <p className="text-lg text-slate-600">Convert Word documents to PDF format.</p>

        <div className="flex items-center justify-center gap-6 py-8">
          <div className="text-center">
            <div className="w-20 h-20 rounded-2xl bg-[#0171DF]/10 flex items-center justify-center mb-2">
              <Text className="text-2xl font-bold" style={{ color: '#0171DF' }}>DOCX</Text>
            </div>
          </div>
        ...
        <div className="border-2 border-dashed border-slate-300 rounded-lg p-12 text-center hover:border-[#0171DF] transition-colors cursor-pointer">
          ...
          <p className="text-lg font-semibold text-slate-900 mb-2">Drop a Word document here or click to upload</p>
          <p className="text-sm text-slate-500">Supports DOCX, DOC</p>
        </div>
