...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://docmaker.io/welcome",
    images: [{ url: "https://docmaker.io/api/og?title=Welcome+to+Docmaker&subtitle=Free+PDF+Tools+%26+AI+Document+Generator", width: 1200, height: 630 }],
  },
  twitter: {
  ...
  alternates: { canonical: "https://docmaker.io/welcome" },
};
...
export default function HomePage() {
  ...
  return (
    <div className="bg-[#F4F6FB]">
      ...
      <section className="py-16 sm:py-24" aria-labelledby="quick-actions-heading">
        <h2 id="quick-actions-heading" className="sr-only">Quick Actions</h2>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* Generate Document - blue */}
            <Link href="/generate" className="rounded-3xl p-6 text-white transition-all hover:scale-[1.02] hover:shadow-xl" style={{ backgroundColor: Brand.blue }}>
              <Sparkles className="h-8 w-8 text-white mb-3" />
              <p className="text-lg font-bold text-white">Generate Document</p>
            ...
            <Link href="/pdf" className="rounded-3xl p-6 text-[#0F172A] transition-all hover:scale-[1.02] hover:shadow-xl" style={{ backgroundColor: Brand.yellow }}>
              ...
              <p className="text-lg font-bold text-[#0F172A]">PDF Tools</p>
            ...
            <Link href="/convert" className="rounded-3xl p-6 text-white transition-all hover:scale-[1.02] hover:shadow-xl" style={{ backgroundColor: Brand.teal }}>
              ...
              <p className="text-lg font-bold text-white">Convert</p>
